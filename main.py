...
def banner():
    print(Fore.CYAN + r"  ____  _                          ____                              ")
    print(Fore.CYAN + r" |  _ \| |__   ___  _ __   ___    |  _ \ ___  ___ ___  _ __  ___ ___ ")
    print(Fore.CYAN + r" | |_) | '_ \ / _ \| '_ \ / _ \   | |_) / _ \/ __/ _ \| '_ \/ __/ __|")
    print(Fore.CYAN + r" |  __/| | | | (_) | | | |  __/   |  _ <  __/ (_| (_) | | | \__ \__ \ ")
    print(Fore.CYAN + r" |_|   |_| |_|\___/|_| |_|\___|   |_| \_\___|\___\___/|_| |_|___/___/")
    print(Fore.GREEN + "  ---------------------------------------------------------------")
    print(Fore.YELLOW + "  PhoneRecon v3.0          --  Number Intelligence Tool")
    print(Fore.YELLOW + "  For Educational & OSINT Use Only")
    print(Fore.MAGENTA+ "  Created by : Rishi Mistry")
    print(Fore.GREEN  + "=" * 60)
...
def main_menu():
  ...
  [!] Spam check scrapes public websites.
            ...
            print(Fore.GREEN  + "\n  [+] Exiting PhoneRecon. Stay ethical.\n")
            print(Fore.MAGENTA+ "      Created by Rishi Mistry | CyberVerse\n")
            break
